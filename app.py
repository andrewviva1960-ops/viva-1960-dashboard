...
async function loadData() {
  ...
  Plotly.newPlot('monthlyChart', [
    {type:'bar', name:'Net Sales', x:monthLabels, y:nsV, marker:{color:_CALM.palette[0],opacity:0.85}, text:nsV.map(v=>fmtShort(v)), textposition:'outside', textfont:{size:11,color:'#4A5568',family:'Inter'}, cliponaxis:false, offsetgroup:1},
    {type:'bar', name:'Expenses', x:monthLabels, y:expV, marker:{color:_CALM.palette[3],opacity:0.85}, text:expV.map(v=>fmtShort(v)), textposition:'inside', textfont:{size:10,color:'#fff',family:'Inter'}, cliponaxis:false, offsetgroup:2},
    {type:'bar', name:'COGS', x:monthLabels, y:cogsV, marker:{color:_CALM.palette[1],opacity:0.85}, text:cogsV.map(v=>fmtShort(v)), textposition:'outside', textfont:{size:11,color:'#4A5568',family:'Inter'}, cliponaxis:false, offsetgroup:2, base:expV}
